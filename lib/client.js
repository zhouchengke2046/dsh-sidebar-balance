		...
		function TriggerWithBalance(props) {
				...
				const load = async () => {
					try {
						...
						if (!res.ok || json === null || json.error) {
							setBal({ data: null, error: String((json && json.error) || "HTTP " + res.status) });
						} else {
							setBal({ data: json, error: null });
						}
					} catch (e) {
						if (!alive) return;
						setBal({ data: null, error: String((e && e.message) || e) });
					}
				};
				load();
			...
			const loadGo = async () => {
				...
				try {
					...
					const json = await res.json().catch(() => null);
					if (!res.ok || json === null || json.error) {
						setGo({ data: null, error: String((json && json.error) || "HTTP " + res.status) });
					} else {
						setGo({ data: json, error: null });
					}
				} catch (e) {
					setGo({ data: null, error: String((e && e.message) || e) });
				} finally {
			...
			let dsCard = null;
			if (bal.error) {
				dsCard = react_jsx_runtime.jsx("div", { className: "psb-err", children: "DeepSeek: " + bal.error });
			} else if (b) {
				...
				dsCard = react_jsx_runtime.jsx("div", { className: "psb-ds-card", children: [
					...
					react_jsx_runtime.jsx("div", { className: "psb-ds-amt", children: [
						...
						react_jsx_runtime.jsx("span", { children: amount ?? "—" })
					] }),
					react_jsx_runtime.jsx("div", { className: "psb-ds-sub", children: [
						react_jsx_runtime.jsx("span", { children: ["充值 ", react_jsx_runtime.jsx("b", { children: sym + (b.topped_up_balance ?? "—") })] }),
						react_jsx_runtime.jsx("span", { children: ["赠送 ", react_jsx_runtime.jsx("b", { children: sym + (b.granted_balance ?? "—") })] })
					] })
				] });
			} else {
			...
			if (go.loading) {
				...
				goSection = react_jsx_runtime.jsx("div", { className: "psb-err", children: go.error });
			} else if (go.data) {
				const defs = [
					...
					rows.push(react_jsx_runtime.jsx("div", {
						...
						children: [
							react_jsx_runtime.jsx("div", {
								...
								children: [react_jsx_runtime.jsx("span", { className: "psb-go-name", children: d.label }), react_jsx_runtime.jsx("span", { className: "psb-go-pct", children: w.percent + "%" })]
							}),
							react_jsx_runtime.jsx("div", {
								className: "psb-track",
